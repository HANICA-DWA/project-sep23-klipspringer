import { FormControl, InputAdornment, IconButton, TextField, Popper, Paper, 
        Button, Typography, LinearProgress, Chip, Divider, Stack } from "@mui/material";
...
export default function SearchBar({ onClick, fullSearch, genreChips, deleteChip, setChips, setActiveSearchFilterPage, booksOnShelf, topThreeLength, setTopThreeLength}) {
